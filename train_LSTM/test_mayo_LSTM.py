...
# ─── VISUALIZACIÓN DEL DATASET (Exploración Inicial) ──────────────────
# print('Generando gráficas de exploración del dataset original...')

# FONT_TITLE = 14
# FONT_LABEL = 12

# 1. Gráfica de Irradiancia Global (G_Glob)
# plt.figure(figsize=(14, 5))
# plt.plot(df.index, df['G_Glob'], color='#F39C12', lw=1.5, label='Irradiancia (G_Glob)', zorder=3)
# plt.gca().xaxis.set_major_formatter(mdates.DateFormatter('%d %b'))
# plt.xticks(rotation=0)
# plt.xlabel('Fecha', fontsize=FONT_LABEL, fontweight='bold')
# plt.ylabel('Irradiancia (W/m²)', fontsize=FONT_LABEL, fontweight='bold')
# plt.title('Perfil de Irradiancia Global del Dataset HIL (2 Semanas)', fontsize=FONT_TITLE, fontweight='bold')
# plt.legend(loc='upper right', fontsize=11)
# plt.grid(True, linestyle='--', alpha=0.6, zorder=0)
# plt.ylim(bottom=0)
# plt.tight_layout()
# plt.savefig(os.path.join(out_dir, '0A_dataset_irradiancia.png'), dpi=300, bbox_inches='tight')
# plt.close()

# # 2. Gráfica de Potencia Real (Pot_inv)
# plt.figure(figsize=(14, 5))
# plt.plot(df.index, df['Pot_inv'], color='#2C3E50', lw=1.5, label='Potencia Real (Inversor)', zorder=3)
# plt.gca().xaxis.set_major_formatter(mdates.DateFormatter('%d %b'))
# plt.xticks(rotation=0)
# plt.xlabel('Fecha', fontsize=FONT_LABEL, fontweight='bold')
# plt.ylabel('Potencia (W)', fontsize=FONT_LABEL, fontweight='bold')
# plt.title('Perfil de Potencia Activa del Dataset HIL (2 Semanas)', fontsize=FONT_TITLE, fontweight='bold')
# plt.legend(loc='upper right', fontsize=11)
# plt.grid(True, linestyle='--', alpha=0.6, zorder=0)
# plt.ylim(bottom=0)
# plt.tight_layout()
# plt.savefig(os.path.join(out_dir, '0B_dataset_potencia.png'), dpi=300, bbox_inches='tight')
# plt.close()
